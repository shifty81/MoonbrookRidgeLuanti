...
core.register_on_joinplayer(function(player)
	...
	core.after(2, function()
		...
		minetest.chat_send_player(player_name, "  /shop - Open Lily's shop")
		minetest.chat_send_player(player_name, "  /balance - Check your coin balance")
		minetest.chat_send_player(player_name, "  /upgrades - View tool upgrade tiers")
		minetest.chat_send_player(player_name, "  /recipes - View discovered recipes")
		minetest.chat_send_player(player_name, "")
